        ...
        <div className="flex flex-col sm:flex-row gap-6 items-stretch w-full">
          ...
          <div className="w-full sm:w-[45%] flex flex-col gap-4">
            <ScrollReveal delay={0.1} className="h-full">
              <div className="h-full bg-white p-5 flex items-center gap-4 rounded-2xl shadow-sm ring-1 ring-gray-100 transition-shadow hover:shadow-md">
                <div className="w-10 h-10 rounded-lg bg-emerald-50 text-emerald-base flex items-center justify-center shrink-0 shadow-sm">
            ...
            <ScrollReveal delay={0.4} className="h-full">
              <div className="h-full bg-emerald-base p-6 rounded-2xl shadow-sm ring-1 ring-emerald-deep transition-shadow hover:shadow-md">
          ...
          <div className="w-full sm:w-[55%] h-full">
            <ScrollReveal delay={0.3} className="h-full">
              <div className="h-full bg-white p-8 rounded-2xl shadow-sm ring-1 ring-gray-100 flex flex-col relative overflow-hidden transition-shadow hover:shadow-md">
